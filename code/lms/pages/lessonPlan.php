    ...
    <form name="form1" method="post" action="" id="form1">
      <table width="94%">
        <tr>
          ...
          <td width="144"><b>Class </b>:        <span id="spryselect1">
          <select name="level" id="level"  onChange="loadReaders()">
          <?php
		  	global $couchUrl;
			global $facilityId;
			$groups = new couchClient($couchUrl, "groups");
        ...
        <tr>
          <td align="left"><b>
            <span style="color: #000; font-style: italic; font-weight:normal;">Fluent :&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;</span>
            <select name="level_Class1" id="level_Class1"  onChange="requestLoadLanguage(1)">
              <?php
		  	global $couchUrl;
			global $facilityId;
			$groups = new couchClient($couchUrl, "groups");
          ...
          <td colspan="2"><p id="sel1">&nbsp;</p></td>
        </tr>
        <tr>
          <td align="left" ><b>
             <span style="color: #000; font-style: italic; font-weight:normal;">Emergent :&nbsp;&nbsp; </span>
                <select name="level_Class2" id="level_Class2"  onChange="requestLoadLanguage(2)">
              <?php
		  	global $couchUrl;
			global $facilityId;
			$groups = new couchClient($couchUrl, "groups");
          ...
          <td colspan="2" ><p id="sel2"></p></td>
        </tr>
        <tr>
          <td align="left"><b><span style="color: #000; font-style: italic; font-weight:normal;">Early :</span><span style="color: #000; font-style: italic; font-weight:normal;">&nbsp; &nbsp;&nbsp;</span><span style="color: #000; font-style: italic; font-weight:normal;">&nbsp; &nbsp;&nbsp;</span>
            <select name="level_Class3" id="level_Class3"  onChange="requestLoadLanguage(3)">
              <?php
		  	global $couchUrl;
			global $facilityId;
			$groups = new couchClient($couchUrl, "groups");
          ...
          <td colspan="2"><p id="sel3"></p></td>
        </tr>
        <tr>
          <td align="left"><b>
             <span style="color: #000; font-style: italic; font-weight:normal;">Other :&nbsp;&nbsp;&nbsp;</span><span style="color: #000; font-style: italic; font-weight:normal;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
             <select name="level_Class4" id="level_Class4"  onChange="requestLoadLanguage(4)">
              <?php
		  	global $couchUrl;
			global $facilityId;
			$groups = new couchClient($couchUrl, "groups");
...
it fun, participatory and self- discovery)</b>
        ...
        <tr>
          <td align="left">&nbsp;</td>
          <td colspan="2"><input type="hidden" name="preparedBy" id="preparedBy" value="<?php echo $_GET['memberId'];?>"></td>
        </tr>
        <tr>
          <td></td>
          <td colspan="2"><input type="submit" class="button" value="Submit">&nbsp;&nbsp;&nbsp;<input name="draft" onClick="saveAsDraft()" type="button" class="button" value="Save As Draft" id="draft">&nbsp;&nbsp;&nbsp;
...
function requestLoadLanguage(num){
	var groupId = document.getElementById("level_Class"+num).value;
	var lang = document.getElementById("Language").value;
	var lev;
	$.getJSON("../functions/get_individual_ResByLangLevel.php?grade="+groupId+"",function (data){
		$.each(data.gobackArr, function(i,gback){
			$("#sel"+num).load("../functions/get_individual_ResByLangLevel.php?lang2="+lang+"&level2="+gback.level+"&number="+num);
		})
	});
...
function loadReaders(){
	var class_index = document.getElementById("level").selectedIndex;
	document.getElementById("level_Class1").selectedIndex = class_index;
	for(var cnt=1;cnt<4;cnt++){
		if(class_index>1){
			document.getElementById("level_Class"+cnt).selectedIndex = (class_index--);
		}
	}
	requestLoadLanguage(1);
	requestLoadLanguage(2);
	requestLoadLanguage(3);
	requestLoadLanguage(4);
}
loadReaders();
	/*requestLoadLanguage(1);
	requestLoadLanguage(2);
...
function saveAsDraft(){
	...
	if(document.getElementById("topic").value==""){
		...
		document.getElementById("topic").value = document.getElementById("topic").value+ " (draft)";
	}
	if(document.getElementById("subtopic").value==""){
		document.getElementById("subtopic").value="."
	}
	if(document.getElementById("aspect").value==""){
		document.getElementById("aspect").value="."
	}
	if(document.getElementById("objectives").value==""){
		document.getElementById("objectives").value="."
	}
	if(document.getElementById("rpk").value==""){
		document.getElementById("rpk").value="."
	}
	if(document.getElementById("corPoints").value==""){
		document.getElementById("corPoints").value="."
	}
	if(document.getElementById("intro").value==""){
		document.getElementById("intro").value="."
	}
	if(document.getElementById("preStage").value==""){
		document.getElementById("preStage").value="."
	}
	if(document.getElementById("stage").value==""){
		document.getElementById("stage").value="."
	}
	if(document.getElementById("postStage").value==""){
		document.getElementById("postStage").value="."
	}
	if(document.getElementById("conclusion").value==""){
		document.getElementById("conclusion").value="."
	}
	if(document.getElementById("LowQuest1").value==""){
		document.getElementById("LowQuest1").value="."
	}
	if(document.getElementById("LowQuest2").value==""){
		document.getElementById("LowQuest2").value="."
	}
	if(document.getElementById("HighQuest1").value==""){
		document.getElementById("HighQuest1").value="."
	}
	if(document.getElementById("HighQuest2").value==""){
		document.getElementById("HighQuest2").value="."
	}
