...
include $_SERVER['DOCUMENT_ROOT'].'/lms/functions/processClassTask.php';?><html>
<head>
...
function requestLoadLanguage(num){
	...
	$.getJSON("../../../functions/get_individual_ResByLangLevel.php?grade="+groupId+"",function (data){
		$.each(data.gobackArr, function(i,gback){
			$("#sel"+num).load("../../../functions/get_individual_ResByLangLevel.php?lang="+lang+"&level="+gback.level+"&number="+num,function() {
				if(num==4){
					document.getElementById('loadingImage').style.display ='none';
					document.getElementById('resTableHandler').style.display ='block';
				}
...
<div id="wrapper" style="background-color:#FFF; width:580px;">
  <div id="rightContent" style="float:none; margin-left:auto; margin-right:auto; width:550px; margin-left:auto; margin-right:auto;"><span style="color:#00C; font-weight: bold;">Stories for the week</span><br><br>
    <form name="form1" method="post" action="">
      <table width="98%" align="center">
        <tr>
          <td width="131"><b>Starting Date</b></td>
          <td width="133"><span id="fldStartD">
          ...
          <td width="64" align="right"><b>End Date</b></td>
          <td width="181"><span id="fldEndDate">
        ...
        <tr>
          ...
          <img name="" src="../../../images/tasks/loading.gif" width="142" height="134" alt="" id="loadingImage">
<table width="100%" border="0" cellpadding="1" cellspacing="1" id="resTableHandler">
  <tr>
          ...
          <td width="74%" colspan="2"><p id="sel1">&nbsp;</p></td>
        </tr>
        <tr>
          <td align="left" ><b>
             <span style="color: #000; font-style: italic; font-weight:normal;">Early :  </span>
        ...
        <tr>
          <td align="left"><b><span style="color: #000; font-style: italic; font-weight:normal;">Emergent:</span>
...
function loadReaders(){
	document.getElementById('resTableHandler').style.display ='none';
